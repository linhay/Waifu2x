        ...
        floatArray.withUnsafeMutableBufferPointer { buffer in
            ...
            rChannel.withUnsafeMutableBufferPointer { channel in
                ...
                for row in 0 ..< validHeight {
                    ...
                    vDSP_vfixu8(
                        buffer.baseAddress!.advanced(by: srcRowStart), 1,
